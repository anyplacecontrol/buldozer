  ...
  render() {
    ...
    return (
      <div className="expenses-article" onClick={this.props.onItemClick}>
        <div className="expenses-article-box --name">
